            ...
            reply_markup: JSON.stringify({
               keyboard: [
                  ...
                  [
                     ...
                     ...(chatId == 874987020 || chatId == 5188347624 || chatId == 5686780147 ? [{
                        text: "💸 Jamg'arma"
                     }] : [])
...
bot.on('callback_query', async msg => {
   ...
   const handleLanguage = async (lang, user) => {
      const keyboardOptions = lang === 'uz' ? [
         // ["🛍 Buyurtma berish"],
         ["Bizning manzil 📍"],
         ["✍️ Fikr bildirish", chatId == 874987020 || chatId == 5188347624 || chatId == 5686780147 ? "💸 Jamg'arma" : ""], // "💸 Jamg'arma"],
         ["ℹ️ Maʼlumot", "⚙️ Sozlamalar"],
         ["👥 Yaqinlarim"]
      ] : [
         // ["🛍 Заказать"],
         ["Наш адрес 📍"],
         ["✍️ Оставить отзыв", chatId == 874987020 || chatId == 5188347624 || chatId == 5686780147 ? "💸 Накопитель" : ''], //"💸 Накопитель"],
